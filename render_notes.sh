...
pandoc -s hash_map.md -o hash_map.html --css style.css --include-in-header header.html
pandoc -s stack_queue.md -o stack_queue.html --css style.css --include-in-header header.html